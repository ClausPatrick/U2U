...
#include "c_logger.h"    //    %%TEST%%

#define general_name "GEN"
#define uart0 0    //    %%TEST%%
#define uart1 1    //    %%TEST%%
#define UART0_IRQ 0    //    %%TEST%%
#define UART1_IRQ 1    //    %%TEST%%

#define MAX_MESSAGE_KEEP 8
#define MAX_MESSAGE_PAYLOAD_SIZE 255
#define MAX_MESSAGE_SIZE 512

//#define BAUD_RATE 115200    //    %%TEST%%
//#define DATA_BITS 8    //    %%TEST%%
//#define STOP_BITS 1    //    %%TEST%%
//#define PARITY UART_PARITY_NONE    //    %%TEST%%
//#define UART_IN uart1    //to DS9    //    %%TEST%%
//#define UART_OUT uart0    //    %%TEST%%
...
//extern const uint8_t sg_WAIT_INDEX         ;    //    %%TEST%%
//extern const uint8_t sg_PREMESSAGE_INDEX   ;    //    %%TEST%%
//extern const uint8_t sg_SENDER_INDEX       ;    //    %%TEST%%
//extern const uint8_t sg_RECEIVER_INDEX     ;    //    %%TEST%%
//extern const uint8_t sg_RQS_INDEX          ;    //    %%TEST%%
//extern const uint8_t sg_TOPIC_INDEX        ;    //    %%TEST%%
//extern const uint8_t sg_CHAPTER_INDEX      ;    //    %%TEST%%
//extern const uint8_t sg_LENGTH_INDEX       ;    //    %%TEST%%
//extern const uint8_t sg_PAYLOAD_INDEX      ;    //    %%TEST%%
//extern const uint8_t sg_HOPCOUNT_INDEX     ;    //    %%TEST%%
//extern const uint8_t sg_CRC_INDEX          ;    //    %%TEST%%
